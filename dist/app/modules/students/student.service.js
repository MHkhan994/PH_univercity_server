...
const createStudentToDb = (student) => __awaiter(void 0, void 0, void 0, function* () {
...
const updateStudentToDB = (id, data) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield student_model_1.StudentModel.updateOne({ id }, data);
    return result;
});
